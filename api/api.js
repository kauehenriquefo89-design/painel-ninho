...
async function fetchFinancialData(access_token) {
  ...
  const [crComp, crVenc, cpComp, cpVenc] = await Promise.all([
    fetchAll("/v1/financeiro/eventos-financeiros/contas-a-receber/buscar", access_token, paramsByComp),
    fetchAll("/v1/financeiro/eventos-financeiros/contas-a-receber/buscar", access_token, paramsByVenc),
    fetchAll("/v1/financeiro/eventos-financeiros/contas-a-pagar/buscar", access_token, paramsByComp),
    fetchAll("/v1/financeiro/eventos-financeiros/contas-a-pagar/buscar", access_token, paramsByVenc),
  ]);
