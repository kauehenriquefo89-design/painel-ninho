...
async function fetchFinancialData(access_token) {
  ...
  const params = {
    ...
    // data_pagamento não é suportado como filtro na API CA
    // mas os campos data_pagamento são retornados nos itens pagos
    // A filtragem por data_pagamento é feita no cliente (normalizarCRfc/CPfc)
  };
